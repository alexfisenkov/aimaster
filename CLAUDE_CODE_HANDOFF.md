...
Обновлено: 2026-09-24, выпуск `2026.09.24`.
...
- Последний выпуск — `2026.09.24` (тег и страница выпуска на том же коммите).
...
- Windows поддерживается нативно с `2026.09.24` (CI на трёх системах);
  живой Windows-компьютер и Telegram на Windows не проверялись.
