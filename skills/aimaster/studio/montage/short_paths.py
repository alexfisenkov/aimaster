...
# (/Users/al не заденет /Users/alex, /app — https://host/app) и не «:» или
# разделитель — «//» схемы URL не путь (http://app:3000, file:///app/x целы);
# справа — разделитель, пробел, кавычка, скобка, знак препинания, «...»,
# точка перед скобкой/кавычкой/пробелом или конец строки.
_BEFORE = r"(?<![\w.:/\\-])"
_AFTER = r"(?=[\\/]|[\s\"'`),;:!?>}\]]|\.(?:[\s.)\]}>\"'`!?,;:]|$)|$)"
