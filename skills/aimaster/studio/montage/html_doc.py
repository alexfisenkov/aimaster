...
# В черновике есть <script> (GSAP и таймлайн main, задача 10b), правки
# допишут свои: текст внутри них и внутри <style>/<!-- --> — не разметка, а
# тег-сканер регэкспом об этом не знает сам.
